  ...
  entries: [
    {
      ...
      name: "taberias",
      description:
        "approximately 53 km (33 mi) in circumference, about 21 km (13 mi) long, and 13 km (8.1 mi) wide. Its area is 166.7 km2 (64.4 sq mi) at its fullest, and its maximum depth is approximately 43 m (141 feet).  At levels between 215 metres (705 ft) and 209 metres (686 ft) below sea level, it is the lowest freshwater lake on Earth and the second-lowest lake in the world (after the Dead Sea, a saltwater lake). The lake is fed partly by underground springs although its main source is the Jordan River which flows through it from north to south.",
      figures: [
        {
          label: "Figure 1",
          value: "20%"
    ...
    },
    {
      ...
      name: "jafar",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum totam minus explicabo. Tenetur veniam exercitationem nisi quidem porro sunt qui.",
      figures: [
        {
          label: "Figure 1",
          value: "20%"
