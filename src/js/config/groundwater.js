export const groundWater = {
  ...
  title: "Ground Water",
  icon: "../ground-water.svg",
  entries: [
    {
      id: "gw1",
      position: { x: 340.0, y: 80.0 },
      name: "Yarmouk Basin",
      balance: "33",
      safeyield: "40",
      extraction: "55"
