...
function (_Component) {
  ...
  function Desalination() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Desalination)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Desalination, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "layer layer--desalination ".concat(activeLayer === 'desalination' ? 'layer--is-active' : 'layer--is-hidden')
      }, _react.default.createElement("div", {
        className: "resources resources--desalination"
      }, _desalinationConfig.default.entries.map(function (_ref2) {
        var id = _ref2.id,
        ...
        }, _react.default.createElement(_DesalinationIcon.default, null));
      })), _desalinationConfig.default.entries.map(function (_ref3) {
        var name = _ref3.name,
