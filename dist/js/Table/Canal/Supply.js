...
function (_Component) {
  ...
  function Supply() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Supply)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Supply, [{
    ...
    value: function render() {
      ...
      })), _supplyConfig.default.entries.map(function (_ref3) {
        var name = _ref3.name,
