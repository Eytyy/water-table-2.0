  ...
  _createClass(MapLayerText, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          renderText = _this$props.renderText,
      ...
      return _react.default.createElement("div", {
        ref: this.textBox,
        style: style,
        className: "project-description project-description--".concat(layerName.toLowerCase(), " project-description--").concat(orientation.x, " project-description--").concat(orientation.y)
