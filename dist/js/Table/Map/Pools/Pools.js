...
function (_Component) {
  ...
  function Pools() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onIncomingEvent", function (message) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "listenToIncomingEvents", function () {
      _api.socket.on('controller', _this.onIncomingEvent);
    });
  ...
  _createClass(Pools, [{
    ...
    value: function componentWillUnmount() {
      ...
      _api.socket.off('controller', this.onIncomingEvent);
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "layer layer--pools ".concat(activeLayer === 'natural' || activeLayer === 'surface' ? 'layer--is-active' : 'layer--is-hidden')
