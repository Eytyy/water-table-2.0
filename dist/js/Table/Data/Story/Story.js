...
function (_Component) {
  ...
  function Story() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getContent", function () {
      return _data.default.find(function (_ref) {
        var year = _ref.year;
        return parseInt(year, 10) === parseInt(_this.state.activeYear, 10);
      }).content;
    });
  ...
  _createClass(Story, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "story"
      }, _react.default.createElement("h1", null, this.state.activeYear), _react.default.createElement("p", null, this.getContent()));
    }
  }]);
